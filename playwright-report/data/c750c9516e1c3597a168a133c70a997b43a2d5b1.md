...
- Name: beta-gate.spec.ts >> Beta gate >> shows Steam login button on beta gate screen
- Location: e2e\beta-gate.spec.ts:15:7
...
Locator: locator('.steam-auth__btn')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('.steam-auth__btn')
