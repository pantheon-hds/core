...
const SteamAuth: React.FC = () => {
  const handleLogin = () => {
    window.location.href = buildSteamAuthUrl();
  };

  return (
    <div className="steam-auth">
      <button className="steam-auth__btn" onClick={handleLogin}>
        <svg className="steam-auth__icon" viewBox="0 0 24 24" fill="currentColor">
