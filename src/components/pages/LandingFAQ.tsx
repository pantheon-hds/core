...
const faqData = [
  {
    ...
    answer: "Absolutely. We use Steam OpenID — the same technology used by thousands of websites. We never receive your password. We only access your public profile: username, avatar, and achievement data. We cannot make purchases, access your inventory, or perform any actions on your account."
  },
  {
    question: "What data do you collect?",
    answer: "Only what Steam makes public: your Steam ID, username, avatar, and achievement completion percentages. We do not collect emails during Steam login, payment information, or any private data. The code is fully open source — you can verify everything yourself on GitHub."
  },
  {
  ...
  },
  {
    ...
    answer: "No. Absolutely not. Ranks cannot be purchased under any circumstances. Bronze through Gold are earned automatically via Steam achievements. Platinum and above require completing community challenges verified by real judges. Money has no place in this system — and that will never change."
  },
  {
  ...
  },
  {
    ...
    answer: "The full platform code is available on GitHub at github.com/pantheon-hds/core. Anyone can read it, audit the security, and contribute improvements. We believe radical transparency is the only honest way to build a community platform."
  },
  {
