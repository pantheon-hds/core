...
**Live platform:** https://pantheon-hds.vercel.app
...
### In development:
- 🔨 Challenge progression system (multiple challenges per rank)
...
### Play and test
Visit https://pantheon-hds.vercel.app, connect your Steam account, and try everything. Report bugs as GitHub Issues.

### Suggest challenges
What do YOU consider worthy of a Platinum rank in Hollow Knight? Open an issue with the tag `challenge-suggestion`.
...
- **Platform:** pantheon-hds.vercel.app
